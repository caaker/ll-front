  ...
  render() {
    ...
    return (
      ...
      <span id='container' className={test}>
        ...
        <span className="holder" onClick = {this.clickHandler.bind(this, 'Clock')}>
        ...
        <span className="holder" onClick = {this.clickHandler.bind(this, 'Article')}>
          <svg className='svg' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
